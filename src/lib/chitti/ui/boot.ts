  ...
  function clipboardFallback(wrap: HTMLElement, text: string, okMsg: string, announce: (m: string) => void) {
    wrap.textContent = '';
  ...
  const PLAN_OFF_PLAN_TOOLS = new Set([
  ...
  function buildPlanCard(plan: InsightBrief, events: TraceEvent[], tokens?: number): HTMLElement {
