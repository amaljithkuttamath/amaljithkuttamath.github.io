...
// keeps working.
import { TOOL_SCHEMAS, RETURN_FINDINGS_SCHEMA } from './schemas';
...
// The always-on core tool-name set now lives in ./schemas. Imported for
// internal use by schemasForSources() below and re-exported so
// `import { CORE_TOOL_NAMES } from './tools'` keeps working.
import { CORE_TOOL_NAMES } from './schemas';
